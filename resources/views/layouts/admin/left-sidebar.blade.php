        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="{{ GlobalHelpers::set_active(['admin.home']) }}"> 
                    <a href="{{route('admin.home')}}" ><span class="hide-menu"><i class="mdi mdi-file"></i> Dashboard </span></a>
                </li>                
                <li class="nav-small-cap">EVENTS COMPONENTS</li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Events</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.event.view.list')}}">List</a></li>
                        <li><a href="{{route('admin.event.view.create')}}">Create</a></li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Event Organizer</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.event_organisers.view.list')}}">List</a></li>
                        <li><a href="{{route('admin.event_organisers.view.create')}}">Create</a></li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Event Category</span></a>
                    <ul aria-expanded="false" class="collapse">
